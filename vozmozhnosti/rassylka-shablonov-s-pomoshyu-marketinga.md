...
{% hint style="info" %}
Обратите внимание, для отправки сообщений в WhatsApp используется тип рассылки «СМС рассылка» а не «Мессенджеры». Через «Мессенджеры» можно написать только в уже созданные Открытые линии. Клиентам, с которыми ещё нет Открытой линии, написать нельзя.

С помощью типа рассылки «СМС-рассылка» и при условии выбора нашего канала «\[Олчат WABA]», производится отправка в WhatsApp по номеру телефона.
{% endhint %}

Создайте новую СМС рассылку.
...
2. В качестве сервиса для отправки выберите сервис «\[Олчат WABA]» с нужным коннектором линии.
