...
* Номер можно сменить, но процесс привязки имеет **важные особенности**. После подключения телефонного номера к WhatsApp Business API его нельзя сразу использовать в обычном приложении WhatsApp. Перед подключением к WABA номер необходимо полностью удалить из всех личных аккаунтов WhatsApp.\
  Как вернуть номер для WhatsApp, можно узнать [здесь](kak-otklyuchit-nomer-ot-whatsapp-business-api-chtoby-podklyuchitsya-k-seromu-whatsapp.md).
