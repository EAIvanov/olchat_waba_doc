...
Это бесплатное приложение на Android и iOS, разработанное специально для владельцев малого бизнеса. Оно не дает доступ к API (к программному интерфейсу) и недоступно для официальных («белых») интеграций. Для неофициальной («серой») интеграции с Битрикс24, рекомендуется использовать именно эту версию.
