...
В качестве сервиса для отправки выберите коннектор Олчат WABA:

<figure><img src="../../.gitbook/assets/image (209).png" alt=""><figcaption></figcaption></figure>

{% hint style="info" %}
Вы можете столкнуться с ситуацией, когда провайдер Олчат WABA не появляется в выборе сервисов отправки. При возникновении такой ситуации, перейдите в приложение Олчат WABA.

На вкладке «СОЕДИНЕНИЕ» проверьте, что линия оплачена а статус соединения с провайдером активен.

На вкладке «НАСТРОЙКИ» проверьте, что в настройках чата активирован чекбокс в пункте «Включить СМС провайдера».
{% endhint %}
...
Откройте приложение Олчат WABA, выберите шаблон и подставьте ссылку на изображение.
...
Определить, открыто ли 24-часовое окно для отправки стандартных сообщений, вы можете с помощью таймера обратного отсчёта в приложении Олчат WABA. Подробнее в статье [#liniya-1](otpravka-shablonov-i-soobshenii-iz-prilozheniya-v-kartochke.md#liniya-1 "mention")
