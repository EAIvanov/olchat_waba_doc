...
Для создания шаблона сообщения, в личном кабинете GupShup перейдите на страницу Дашборд (рабочей панели). Нажмите на название приложения, для которого нужно добавить шаблон:
...
Переменная вставляется в текст шаблона в виде порядкового номера переменной в двойных фигурных скобках: \{{1\}}, \{{2\}} и т.д.
...
После ввода всей необходимой информации, справа в Preview (в поле предпросмотра) отобразится готовый сформированный шаблон и пример, как он будет выглядеть.
