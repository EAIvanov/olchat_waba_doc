...
#### Как добавить кнопку в шаблон в GupShup.

Как создать шаблон с кнопками, подробно описано [здесь.](https://waba.docs.olchat.io/lichnyi-kabinet-gupshup/sozdanie-i-upravlenie-shablonami-soobshenii#sozdanie-shablona-s-knopkami)

#### Обработка нажатия на кнопку

Когда клиент нажимает кнопку «Отписаться», в ОЛ приходит входящее сообщение с текстом кнопки.
...
Подробнее можно ознакомиться [здесь](https://waba.docs.olchat.io/keisy/otpravka-shablona-soobsheniya-s-knopkami-i-obrabotka-otvetov-robotom-ozhidanie-soobsheniya).
