...
{% hint style="info" %}
По умолчанию пользователям открывается англоязычная версия сайта GupShup. После прохождения процесса регистрации или авторизации, на вкладке «Dashboard» (рабочая панель) появится возможность смены языка сайта путем нажатия на кнопку «English» (английский) в правом верхнем углу.
{% endhint %}

### Дашборд (рабочая панель)/ WhatsApp
...
3. Вкладка **«**[**Мой профиль**](interfeis-gupshup.md#moi-profil)**»**. При нажатии позволяет узнать ключ API (программного интерфейса), необходимый для отправки сообщений через WhatsApp.
...
5. Окно **«Подробная информация о клиенте»** содержит в себе информацию об ID (об идентификаторе) пользователя. Данная информация дублируется из вкладки «дашборд / WhatsApp».
6. В окне **«Часовой пояс по умолчанию»** рекомендуется выбрать из выпадающего списка свой часовой пояс, чтобы даты и время в выписках финансовых операций соответствовали реальному времени совершения платежа в вашем часовом поясе.
