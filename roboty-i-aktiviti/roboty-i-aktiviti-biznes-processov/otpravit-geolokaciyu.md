...
Робот «\[Олчат WABA] Отправить геолокацию» позволяет на определённой стадии в автоматизированном режиме отправлять в чат с клиентом геометку.
...
4. Нажмите «Добавить» напротив «\[Олчат WABA] Отправить геолокацию».
