...
Робот «\[Олчат WABA] Отправить файл» позволяет на определённой стадии в автоматизированном режиме отправлять в чат с клиентом файлы различного типа: документы и изображения, аудио- и видеофайлы.
...
4. Нажмите «Добавить» напротив «\[Олчат WABA] Отправить файл».
