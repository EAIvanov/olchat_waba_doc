...
6. Укажите причину срабатывания триггера: нажмите «<img src="../../.gitbook/assets/image (309).png" alt="" data-size="line">», далее выберите «Роботы» — «\[Олчат WABA] Проверить наличие WhatsApp» — «Номер существует?»
