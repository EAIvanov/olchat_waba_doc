...
При отправке файла с помощью активити или робота «\[Олчат WABA] Отправка файла» и выборе типа источника файла доступны варианты «Прямая ссылка на файл», «Битрикс24.Диск (ID (идентификатор)  файла)», «Файл из поля CRM» и «Короткая ссылка Битрикс24».
