...
Стоимость WhatsApp Business API (программного интерфейса WhatsApp Business) складывается из следующих составляющих:

1. Оплата за приложение для интеграции с Битрикс24 (нам, в рублях). Подробнее в статье [Оплата приложения Олчат WABA](https://waba.docs.olchat.io/tarify-prilozheniya/oplata-prilozheniya-whatsabi) и в разделе [Тарифы Олчат WABA](./#tarify-olchat-waba).
...
Стоимость приложения для интеграции с Битрикс24 — **3 600 рублей** за 1 аккаунт (номер телефона) на 30 дней.
...
С 1 января 2026 года компания Meta\*\* переводит отправку маркетинговых шаблонов в WABA\* со старой технологии Cloud API на новый протокол — **MM Lite (**&#x43E;блегчённый режим рассылки маркетинговых сообщений через WhatsApp Business API). Полноценный запуск MM Lite ожидается ближе к концу года, а пока всем пользователям **нужно заранее принять новые условия**. До этого момента рассылки продолжают работать через Cloud API.

#### Кому необходимо перейти?

MM Lite становится новым стандартом **для всех** **маркетинговых рассылок** в WhatsApp\*:

* Все пользователи должны поддерживать технологию **с 1 января 2026 года**.
* Новые номера WABA\* будут подключаться только по MM Lite.

Если вы уже пользуетесь WABA\*, достаточно принять новое соглашение в **Facebook Business Manager**\* (FBM). При этом WABA\* не будет отключена у тех, кто останется на Cloud API, однако стоимость отправки маркетинговых шаблонов временно увеличится на **7%**, пока вы не примете новые условия.

{% hint style="warning" %}
Подробнее о MM Lite и о том, как перейти на новую технологию, написано в [данной статье](../bystryi-start/mm-lite.md).
{% endhint %}
