...
С 1 января 2026 года компания Meta\*\* переводит отправку маркетинговых шаблонов в WABA\* со старой технологии Cloud API на новый протокол — **MM Lite**. Полноценный запуск MM Lite ожидается ближе к концу года, а пока всем пользователям **нужно заранее принять новые условия**. До этого момента рассылки продолжают работать через Cloud API.
