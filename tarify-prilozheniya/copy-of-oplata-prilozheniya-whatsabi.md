...
# Copy of Оплата приложения Олчат WABA

Для оплаты Олчат WABA выполните следующие действия:

{% stepper %}
{% step %}
Перейдите в приложение Олчат WABA и выберите пункт «Оплата».
...
Список открытых линий можно отсортировать по названию, а также оставшемуся сроку оплаты. Для этого нажмите <img src="../.gitbook/assets/image (2) (1) (1) (1).png" alt="" data-size="line"> рядом с наименованием столбца.
...
{% step %}
Оплата приложения Олчат WABA завершена.
{% endstep %}
{% endstepper %}
