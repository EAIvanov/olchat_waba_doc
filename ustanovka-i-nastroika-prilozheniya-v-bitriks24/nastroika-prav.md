...
Настройка прав для работы с Олчат WABA выполняется на портале в нескольких разделах. Чтобы приложение функционировало корректно, сотрудникам, которые будут его использовать и настраивать, необходимо предоставить права на следующие элементы: само приложение Олчат WABA, настройку открытой линии, карточку CRM (системы управления взаимоотношениями с клиентами), коннектор линии.
...
Воспользуйтесь поиском, чтобы быстро найти сотрудника или отдел, либо отметьте желаемые категории и отделы в структурированном списке.
...
Для того, чтобы изменить права на приложение или просмотреть, под правами какого пользователя Олчат WABA работает в данный момент, выполните следующие действия:
...
{% stepper %}
{% step %}
Перейдите в магазин приложений Битрикс24, выбрав его в меню слева на портале.
{% endstep %}
...
Права на использование открытой линии можно настроить двумя способами: из приложения Олчат WABA и через контакт-центр.

Чтобы выдать права на настройку открытой линии через приложение Олчат WABA, выполните следующие действия:
...
{% step %}
Левой кнопкой мыши выберите карточку Олчат WABA, чтобы открыть список линий, подключённых к приложению.
