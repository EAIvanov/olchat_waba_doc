...
Для того чтобы подключить открытую линию в приложении Олчат WABA, необходимо выполнить следующие действия:

{% stepper %}
{% step %}
#### Откройте приложение Олчат WABA.
...
{% step %}
В поле «**Токен**» укажите API (программный интерфейс) ключа приложения WhatsApp, полученный в личном кабинете GupShup.
...
Название приложения можно скопировать в личном кабинете GupShup на вкладке Dashboard (рабочая панель)/ WhatsApp в строках, содержащих информацию о подключенных приложениях.
